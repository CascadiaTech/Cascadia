                ...
                <div>
                  <animated.div style={props} key={key}>
                    <div className={'animate__animated animate__animate__fadeInDown'}>
                      <div className=" bg-grey-900 translate-y-14">
                        <footer className="relative top-20 -z-1 text-center bg-gray-900 text-white w-screen mt-10">
              ...
              "
                                  ...
                                  <div className="md:mr-auto mb-6">
                                    <button
                                      type="submit"
                                      value="Submit"
                                      className="cursor-pointer inline-block px-6 py-2 border-2 border-white text-white font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
                                    >
                                      Contact us
                                    </button>
                                  </div>
